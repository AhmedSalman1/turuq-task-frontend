 ...
 * Kept dependency-free so the app stays lean; add new icons here as needed.
 */
...
/** Shared SVG attributes so every icon renders consistently. */
const ICON_DEFAULTS = {
...
export function CakeIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg {...ICON_DEFAULTS} width={size} height={size} {...props}>
